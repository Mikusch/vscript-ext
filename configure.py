...
parser.options.add_argument('--enable-auto-versioning', action='store_false', dest='disable_auto_versioning',
                       default=True, help='Enable automatic versioning')
parser.options.add_argument('-s', '--sdk', default='all', dest='sdks',
                       help='Build against specified SDKs; valid args are "all", "present", or '
                            'comma-delimited list of engine names (default: all)')
parser.options.add_argument('--sdk-root', type=str, dest='hl2sdk_root', default=None,
